							...
							<div class="st-dropdown-content-group b-t bw-2">
								...
								<div class="row">
									<div class="col mr-4">
										...
										<a  href="cookie-law.html">Cookielaw</a>
									</div>
									<div class="col mr-4">
			...
			<div class="st-dropdown-container">
				<div class="st-dropdown-section" data-dropdown="aboutus">
					<div class="st-dropdown-content">
						...
						<div class="st-dropdown-content-group">
							...
							<div class="ml-5 row">
								<div class="col">
									<span class="dropdown-item color-2">Facebook </span>
									<span class="dropdown-item color-2">Twiter </span>
								</div>
								<div class="col">
									<span class="dropdown-item color-2">Linkden </span>
									<span class="dropdown-item color-2">Instagram </span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="st-dropdown-content-group">
							<div class="row">
								<div class="col">
									...
									<i class="far fa-github-square icon"></i> Github </a>
								</div>
								<div class="col">
									<a class="dropdown-item bold"  href="#">
									<i class="far fa-youtube icon"></i> Youtube </a>
								</div>
								<div class="col">
									<a class="dropdown-item bold"  href="#">
				...
				<div class="st-dropdown-section" data-dropdown="products">
					<div class="st-dropdown-content">
						<div class="st-dropdown-content-group">
							<a class="dropdown-item"  href="<?php echo SITE_URL ?>/products/messaging">
								<div class="media mb-4">
									...
									<div class="media-body">
										<h3 class="link-title m-0">Messaging</h3>
							...
							<a class="dropdown-item"  href="<?php echo SITE_URL ?>/products/voice">
								<div class="media mb-4">
									...
									<div class="media-body">
										<h3 class="link-title m-0">Voice</h3>
										<p class="m-0 color-2">Get to know DashCore color options</p>
									</div>
								</div>
							</a>
							...
							<a class="dropdown-item"  href="<?php echo SITE_URL ?>/products/rcs">
								<div class="media mb-4">
									...
									<div class="media-body">
										<h3 class="link-title m-0">RCS</h3>
							...
							<a class="dropdown-item"  href="<?php echo SITE_URL ?>/products/whatsappbuisness">
								<div class="media mb-4">
									...
									<div class="media-body">
										<h3 class="link-title m-0">WhatsaApp For business</h3>
										<p class="m-0 color-2">Comply with the hideous EU Cookie Law</p>
									</div>
								</div>
							</a>
							<a class="dropdown-item"  href="<?php echo SITE_URL ?>/products/viberbuisness">
								<div class="media mb-4">
									...
									<div class="media-body">
										<h3 class="link-title m-0">Viber For business</h3>
										<p class="m-0 color-2">Comply with the hideous EU Cookie Law</p>
									</div>
								</div>
							</a>
						...
						<div class="st-dropdown-content-group">
							<span class="dropdown-item d-flex align-items-center text-muted">... </span>
						</div>
					</div>
				</div>
				<!-- END Produits -->
				...
				<div class="row gap-y" style="">
					<div class="col-md-7" style="padding-top: 28px;">
						<h1 class="extra-bold display-md-3 font-md" style="font-size: 3.5rem !important;">
							Engage Customers
							<span class="d-block light" style="font-size: 50px;padding-top: 15px;">Faster, Easier &amp; Cheaper </span>
						</h1>
						<p class="lead">Over-The-Top Enterprise-Class Multi-Channel Customer Engagement Application To Ensure Your Digital Mobile Engagement Meets Your Customer's Expectations</p>
					</div>
				</div>
			</div>
                ...
                <div class="shadow bg-1 p-4 rounded">
                    <div class="row gap-y text-center">
                        <div class="col-12 col-md-4 py-4 px-5 d-flex flex-column b-r">
                            ...
                            <p class="mt-4">Powered with one of the most popular front-end CSS toolkits.</p>
                        </div>
                        <div class="col-12 col-md-4 py-4 px-5 d-flex flex-column b-r">
                            <div class="icon-shape mb-4">
                            ...
                            <p class="mt-4">Admin template powered with Angular 7+.</p>
                        </div>
                        <div class="col-12 col-md-4 py-4 px-5 d-flex flex-column">
                            ...
                            <p class="mt-4">Dashcore is packed with multiple high-quality UI components.</p>
                        </div>
                    </div>
                </div>
            </div>
			...
			<div class="container pb-9">
				<div class="row gap-y align-items-center py-5">
					...
					<div class="col-md-6">
						...
						<h2 class="bold text-capitalize">Messaging SMS & MMS</h2>
						...
						<a href="javascript:;" class="btn gradient gradient-43 color-1 btn-rounded btn-outline-1 bw-2 bold mt-4">All The Features</a>
				...
				<div class="row gap-y align-items-center py-5">
					...
					<div class="col-md-6">
						...
						<h2 class="bold text-capitalize">Voice </h2>
						<p class="regular">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium autem dolorem eaque est eum fugit harum maiores minima nisi nobis, possimus, quas qui quo ratione sequi suscipit vel vero voluptas?</p>
				...
				<div class="row gap-y align-items-center py-5">
					...
					<div class="col-md-6">
						...
						<h2 class="bold text-capitalize">Rich Communication Service (RCS) </h2>
						<p class="regular">A comprehensive SMS & MMS platform providing next-generation Rich Communication Service (RCS), for better customer interaction experience and ease transformational communication that mobile users demand.</p>
						<a href="javascript:;" class="btn gradient gradient-43 color-1 btn-rounded btn-outline-1 bw-2 bold mt-4">Learn More</a>
					</div>
				</div>
		...
		<section class="section">
			...
			<div class="container pb-9">
				<div class="section-heading text-center">
					...
					<p class="lead color-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto, assumenda autem consequatur cum dignissimos dolores doloribus eius eum iusto laborum quasi quidem sapiente sit.</p>
				</div>
				<div class="row">
					<div class="col-md-4 col-lg-3 ml-lg-auto order-md-2">
						...
						<hr class="mt-5">
						<a href="javascript:;" class="nav-link accent">Full resources reference
