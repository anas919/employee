...
<body @if(Auth::user()->pref_theme == 0) class="menu-position-side menu-side-left full-screen with-content-panel" @else class="menu-position-side menu-side-left full-screen with-content-panel color-scheme-dark" @endif>
